...
use Andruby\DeepAdmin\Components\Antv\Area;
use Andruby\DeepAdmin\Components\Antv\Column;
use Andruby\DeepAdmin\Components\Antv\Line;
use Andruby\DeepAdmin\Components\Antv\StepLine;
...
use Andruby\DeepAdmin\Layout\ChartCard;
        ...
        $content->className('m-10')
            ->row(function (Row $row) {
                ...
                $row->column(12, ChartCard::make()->title('测试标题')
                    ...
                    ->data_url(config('deep_admin.route.api_prefix') . '/home/chart_data')
