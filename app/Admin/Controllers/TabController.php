...
use Andruby\DeepAdmin\LeftGrid;
use Andruby\DeepAdmin\TabForm;
...
class TabController extends ContentController
{
    ...
    protected function grid()
    {
        ...
        $action = config('deep_admin.route.api_prefix') . '/tab/getFilter?type=1';
    ...
    protected function form($isEdit = 0)
    {
        ...
        $options = [];
        $this->remoteUrl = config('deep_admin.route.api_prefix') . '/select/related_select';
        $action = config('deep_admin.route.api_prefix') . '/tab/getTab';
